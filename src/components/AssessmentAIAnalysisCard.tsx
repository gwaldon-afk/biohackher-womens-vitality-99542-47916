...
export const AssessmentAIAnalysisCard = ({
  ...
  // If custom button is provided and no analysis yet, just render the button
  if (renderButton && !analysis && !loading) {
    return <>{renderButton(() => generateAnalysis(), loading)}</>;
  }

  // If custom button and analysis exists, show full card
  if (renderButton && analysis) {
    return (
    <Card>
      <CardHeader>
