...
const EnergyProgressChart = lazy(() => import("./EnergyProgressChart"));
...
export default function EnergyProgress() {
  ...
  return (
    <div className="container max-w-6xl mx-auto px-4 py-8 space-y-8">
      ...
      <LazyOnVisible
        minHeight={460}
        fallback={<Card className="p-6 text-center text-muted-foreground">Loading chart…</Card>}
      >
        <Suspense fallback={<Card className="p-6 text-center text-muted-foreground">Loading chart…</Card>}>
          <EnergyProgressChart chartData={chartData} />
        </Suspense>
      </LazyOnVisible>
