          ...
          <div className="mb-4">
            <div className="text-center mb-6">
              ...
              <p className="text-lg text-primary font-medium max-w-4xl mx-auto mb-4">
                Stop wondering "Is this normal?" Get personalized insights into your symptoms and discover science-backed solutions tailored specifically for your body.
              </p>
              <p className="text-sm text-muted-foreground max-w-2xl mx-auto">
                Choose a pillar below to see relevant assessments, or view all available assessments. Each assessment creates personalized supplement recommendations for your 30-day stack.
              </p>
            </div>
