      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Evidence-based educational information for common symptoms during hormonal transitions
          </p>
          <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 mt-4">
            <p className="text-sm text-orange-800">
              <strong>⚠️ Educational Information Only:</strong> This content is for educational purposes only and is not medical advice. 
              Always consult with qualified healthcare professionals before starting any new supplements, protocols, or making health decisions. 
