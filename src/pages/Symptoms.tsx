          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {assessedSymptoms.map((symptom) => {
                ...
                return (
                  <Card key={symptom.id} className="border-primary/50 bg-primary/5">
                    <CardContent className="p-4">
                  ...
                  <label
                    ...
                    className={`cursor-pointer flex flex-col items-center p-4 rounded-lg border-2 transition-all hover:scale-105 hover:shadow-md w-full max-w-[140px] ${
                      selectedSymptom === symptom.id
                        ...
                        : 'border-gray-200 bg-background hover:border-primary/50 hover:bg-primary/5'
                    }`}
                    onClick={() => handleSymptomSelect(symptom.id)}
                  >
                    <symptom.icon className={`h-8 w-8 mb-3 ${
                      selectedSymptom === symptom.id ? 'text-primary-foreground' : 'text-muted-foreground'
                    }`} />
                    <span className={`text-sm font-medium text-center leading-tight ${
                      selectedSymptom === symptom.id ? 'text-primary-foreground' : 'text-foreground'
                    }`}>
                      {symptom.name}
                    </span>
