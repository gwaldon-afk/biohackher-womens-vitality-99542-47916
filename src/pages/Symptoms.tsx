          ...
          <div className="mb-4">
            <div className="text-center mb-6">
              <div className="flex items-center justify-center gap-2 mb-2">
                <h1 className="text-3xl font-bold gradient-text">Symptom Assessment</h1>
                <ScienceBackedIcon className="h-6 w-6" />
              </div>
              <p className="text-lg text-primary font-medium max-w-4xl mx-auto">
                Stop wondering "Is this normal?" Get personalized insights into your symptoms and discover science-backed solutions tailored specifically for your body. Understanding your symptoms is the first step toward feeling like yourself again.
              </p>
            </div>
