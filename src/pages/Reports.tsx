...
const Reports = () => {
  ...
  const reportData = {
    "30-day": {
      ...
      recommendations: [
        "Continue current sleep optimization protocol",
    ...
    "90-day": {
      ...
      recommendations: [
        "Consider HRT consultation for symptom optimization",
...
Key improvements in sleep optimization and symptom management protocols.
...
Factors: Sleep quality, HRV training, nutrition optimization
...
• Sleep Optimization: 27/30 nights
